...
### Cleaning CIA Data Frame[link to final code]:
...
* An [exploratory notebook](https://github.com/namin1993/Capstone_Project/blob/Lauren_week_2/secgment_2%20API/nyt_api_explore_json.ipynb) was created to identify JSON targets for parsing.
